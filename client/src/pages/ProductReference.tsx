    ...
    epics: [
      {
        ...
        stories: [
          ...
          { title: "interaction_info table stores client and pathway strings for filtering", status: "done" },
    ...
    epics: [
      {
        ...
        stories: [
          { title: "interaction_info table with processing metrics, tokens, cost", status: "done" },
          { title: "interaction_observations table with per-observation detail", status: "done" },
          { title: "interaction_qa_pairs table with full Q&A extraction per call", status: "done" },
    ...
    epics: [
      ...
      },
      {
        ...
        stories: [
          ...
          { title: "Each item: fetch transcript → call Gemini → write interaction_info + interaction_observations + interaction_qa_pairs + barriers", status: "done" },
        ...
        stories: [
          {
            ...
            acceptanceCriteria: [
              ...
              "Cross-references interaction_info.source_id to determine processed vs unprocessed",
          ...
          },
          {
            ...
            acceptanceCriteria: [
              ...
              "Writes to interaction_info (summary, observations_summary, follow_up, tokens, cost)",
              "Writes to interaction_observations (one row per observation topic with value, detail, evidence, confidence)",
              "Writes to interaction_qa_pairs (one row per Q&A exchange with category and observation linkage)",
