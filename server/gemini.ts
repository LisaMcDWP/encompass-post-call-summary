...
Your response MUST be valid JSON with exactly this structure:
{
  ...
  "transition_status": "A bulleted list (using bullet character •) covering ALL of the post-discharge transition topics below. Each bullet MUST be on its own line. Each bullet MUST follow this exact format: '• Topic: [STATUS] Detail text here.' where [STATUS] is a brief category label in square brackets. Always include every bullet — if a topic was not discussed, use [Not Discussed].\\n\\n• Overall Feeling: [STATUS] detail. Status options: Good, Fair, Poor, Not Discussed.\\n• Disposition Change: [STATUS] detail. Status options: No Readmission, Readmitted, Not Discussed.\\n• Prescription Pickup: [STATUS] detail. Status options: Picked Up, Not Picked Up, Partially Picked Up, Not Asked, Unknown.\\n• Medication Adherence: [STATUS] detail. Status options: No Issues, Has Barriers, Not Discussed.\\n• Follow-up Appointment: [STATUS] detail. Status options: Scheduled, Not Scheduled, Completed, Cancelled, Not Discussed.\\n• DME or Supplies Delivered: [STATUS] detail. Status options: Delivered, Partially Delivered, Not Delivered, Ordered Not Received, Not Ordered, Not Discussed, Unknown.\\n• Home Health Visit: [STATUS] detail. Status options: Completed, Scheduled, Missed, Pending, Not Discussed.\\n• Discharge Instructions: [STATUS] detail. Status options: No Questions, Has Questions, Not Discussed.\\n• Encompass Feedback: [STATUS] detail. Status options: Positive, Mixed, Negative, Not Discussed.\\n• Experience Comments: [STATUS] detail. Status options: Positive, Mixed, Negative, Not Discussed.\\n• Other: any other important information the patient provided. If none, write 'None.'",
  "follow_up_areas": "A bulleted list (using bullet character •) of potential follow-up areas based ONLY on the topics covered in the transition_status. Each bullet should be on its own line. Only include follow-up items that directly relate to issues, concerns, or gaps identified in the transition status bullets above (e.g. missing prescriptions, cancelled appointments, undelivered DME, missed home health visits, medication barriers, etc.). Do not add follow-up items for topics that had no issues. If no follow-up areas were identified, write 'No follow-up areas identified.'"
}
...
- follow_up_areas: List follow-up items as bullets ONLY for issues or concerns identified in the transition_status. Each item should directly tie back to a specific transition status topic that had a problem, gap, or unresolved issue. Do not create follow-up items for topics that were positive or had no issues. Be concrete with dates, names, and details from the transcript.
Call ID: {{CALL_ID}}
