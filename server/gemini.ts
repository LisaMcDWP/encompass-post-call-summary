...
- transition_status: Extract each transition detail as a bulleted item using the • character. Each bullet should start with a bold category label followed by the detail. Only include bullets for topics that were actually discussed in the call. This field should read like a concise clinical status report.
